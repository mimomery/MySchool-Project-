...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open ">
            <a href="{{url('emploie')}}" class="nav-link active ">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">EMPLOIE DU TEMPS</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <div class="col">
    ...
    <select id="filter-select2" class="form-control">
      <option value="name">2022</option>
      <option value="age">2023</option>
      <option value="email">2024</option>
      <option value="name">2025</option>
      <option value="age">2026</option>
      <option value="email">2027</option>
    </select>
  </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-sm btn-primary" style="float: right;" data-toggle="modal" data-target="#addStudentModal">Take Attendance</button>
                    </div>
                    <div class="card-body">
